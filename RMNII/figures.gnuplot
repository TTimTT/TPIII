...
plot datadir."C01" using 1:(1-$3/1083)*0.5:(sqrt($4)) with yerrorbars notitle, f(x) title 'Fit'
...
plot datadir."C015" using 1:(1-$3/913)*0.5:(sqrt($4)) with yerrorbars notitle, f(x) title 'Fit'
...
plot datadir."C03" using 1:(1-$3/461)*0.5:(sqrt($4)) with yerrorbars notitle, f(x) title 'Fit'
