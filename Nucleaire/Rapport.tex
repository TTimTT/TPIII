...
\subsection{Tantalum 181 activity, period and age of the sample}
...
\subsubsection{Activity}
	...
	The activity of the tantalum 181 sample we had can be measured with this relation :
	...
	By these value we have, $A = -6.4061e+04 $

Due to unaccurate value of $m_m$ it is impossible to get a decent value for the Activity, this might be due to a bad calibration or a bad measurement by the experimentalist physicist.
...
\subsubsection{Period}
	...
	% $\tau = 1/0.00994745$
	Which gives, $\tau = 1.0348 \cdot 10^8$ seconds which is $3.27915$ years.
