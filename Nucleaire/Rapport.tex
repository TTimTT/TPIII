...
\subsubsection{activity}
	...
	\be
		A = \frac{m_1 m_2}{2 m_r}
	\ee

	where $m_1$ and $m_2$ are the measurements got in the last part and $m_r$ is the real coincidence discussed before.
...
\subsubsection{period}
	...
	By measuring the coincidence with a delay, we can use the relation :

	\be
		p(t)= \lambda e^{-\frac{t}{\tau}}
	\ee

	where $p$ represent the distribution function for the delay, $\lambda$ a factor for normalization, $t$ the delay and $\tau$ the period of the observed particle.

	!!! METTRE LE GRAPHE AVEC LE FIT EXPONENTIEL QUE T'AS FAIT EN DERNIER.
